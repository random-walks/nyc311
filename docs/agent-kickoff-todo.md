...
- Add or outline one notebook or report-card workflow for a community-district example.
- Tighten the README so the value proposition, methodology, and first successful workflow are immediately obvious.
