...
- Queens shows the strongest party-music intensity at `66.7%` (2 of 3 complaints).
- Brooklyn shows the weakest party-music intensity at `25.0%` (1 of 4 complaints).
- The sharpest single-topic signal appears in `Queens`, where `Party Music` accounts for `66.7%` (2 of 3).
- The flattest topic mix appears in `Brooklyn`, where the leading topic accounts for only `25.0%` (1 of 4).
