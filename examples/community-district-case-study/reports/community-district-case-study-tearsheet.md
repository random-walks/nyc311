...
- The cached slice contains `15000` complaint records across `20` community districts.
- The largest complaint category is `Illegal Parking` with `3264` records (21.8% of the slice).
- The busiest district is `BROOKLYN 05` with `1266` complaints.
- The strongest party-music intensity appears in `BROOKLYN 04`, where party music accounts for `86.7%` of sampled residential-noise complaints.
- The weakest district-level resolution rate appears in `BROOKLYN 55`, where `7.1%` of complaints remain unresolved.
- The complaint group with the weakest overall resolution rate is `Construction Lead Dust` at `100.0%` unresolved.
