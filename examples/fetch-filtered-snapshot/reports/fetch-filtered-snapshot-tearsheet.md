...
- Saved rows: `500` at
  `/Users/blaise/Desktop/blaise-oss/nyc311/examples/fetch-filtered-snapshot/cache/rodent-snapshot.csv`.
- Primary complaint mix leader: `Rodent` with `500` rows (100.0%).
- Applied filters: `borough = BROOKLYN`, `2025-01-01` to `2025-01-31`, complaint
  types `Rodent`.
