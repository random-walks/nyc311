...
consumer workflow. Regenerate it only when you intentionally want to update the
...
- Saved rows: `6000` at
  `/Users/blaise/Desktop/blaise-oss/nyc311/examples/fetch-filtered-snapshot/cache/brooklyn-noise-snapshot.csv`.
- Primary complaint mix leader: `Noise - Residential` with `6000` rows (100.0%).
- Applied filters: `borough = BROOKLYN`, `2025-01-01` to `2025-03-31`, complaint
  types `Noise - Residential`.
